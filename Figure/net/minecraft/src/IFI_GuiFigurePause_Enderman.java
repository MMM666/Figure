...
public class IFI_GuiFigurePause_Enderman extends IFI_GuiFigurePause {
	...
	public void readEntityFromNBT(NBTTagCompound nbttagcompound) {
		// 特殊なデータ読み込みを実行
		eenderman.setScreaming(nbttagcompound.getBoolean("Attacking"));
	}

	public void writeEntityToNBT(NBTTagCompound nbttagcompound) {
		// 特殊なデータ書き込みを実行
		nbttagcompound.setBoolean("Attacking", eenderman.isScreaming());
	}
	...
	protected void actionPerformed(GuiButton guibutton) {
		...
		case 103:
			...
			guibutton.displayString = button103[eenderman.getCarried() > 0 ? 0
					: 1];
			break;
